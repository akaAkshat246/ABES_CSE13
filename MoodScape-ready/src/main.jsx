...
const MOODS = {
  happy: {
    ...
    energy: 88,
    stress: 18,
    gradient: 'linear-gradient(135deg, #ff007f 0%, #ff6b3d 50%, #fcd34d 100%)',
    accent: '#ff007f',
    ink: '#290010',
    sky: '#fff0f5',
  ...
  calm: {
    ...
    energy: 48,
    stress: 12,
    gradient: 'linear-gradient(135deg, #8b5cf6 0%, #6366f1 50%, #34d399 100%)',
    accent: '#8b5cf6',
    ink: '#0a041f',
    sky: '#f3f0ff',
  ...
  focused: {
    ...
    energy: 72,
    stress: 26,
    gradient: 'linear-gradient(135deg, #020617 0%, #0c142c 60%, #39ff14 100%)',
    accent: '#39ff14',
    ink: '#051f04',
    sky: '#e6fdf2',
  ...
  angry: {
    ...
    energy: 91,
    stress: 68,
    gradient: 'linear-gradient(135deg, #0a0104 0%, #3f0010 50%, #ff003c 100%)',
    accent: '#ff0055',
    ink: '#1c0006',
    sky: '#ffe4e6',
