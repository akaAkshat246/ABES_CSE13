...
const MOODS = {
  ...
  calm: {
    ...
    energy: 48,
    stress: 12,
    gradient: 'linear-gradient(135deg, #2E5B5D 0%, #48C9B0 50%, #A2D9CE 100%)',
    accent: '#48C9B0',
    ink: '#0C2B24',
    sky: '#EAFaf1',
  ...
  focused: {
    ...
    energy: 72,
    stress: 26,
    gradient: 'linear-gradient(135deg, #0D1B2A 0%, #2575fc 60%, #00f2fe 100%)',
    accent: '#00f2fe',
    ink: '#0D1B2A',
    sky: '#E3F2FD',
  ...
  stressed: {
    ...
    energy: 42,
    stress: 78,
    gradient: 'linear-gradient(135deg, #2A2E45 0%, #B06AB3 100%)',
    accent: '#B06AB3',
    ink: '#1F1A3A',
    sky: '#F5F3FF',
  ...
  angry: {
    ...
    energy: 91,
    stress: 68,
    gradient: 'linear-gradient(135deg, #1A0B14 0%, #E94057 50%, #F27121 100%)',
    accent: '#E94057',
    ink: '#3B0B14',
    sky: '#FFF0F2',
      ...
      <div className="footer-content">
        ...
        <div className="footer-author-card">
          ...
          <div className="author-connect-tiles" style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginTop: '16px' }}>
            ...
            <a 
              href="mailto:akshatavs1122@gmail.com" 
              target="_blank" 
              rel="noopener noreferrer"
              className="connect-tile tile-gmail"
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            >
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-1.298 1.458-2.057 2.509-1.27l9.491 7.118 9.491-7.118C22.542 3.4 24 4.159 24 5.457z"/>
              </svg>
            </a>
          </div>
        </div>
...
function AppleHelloLoader({ onComplete }) {
  useEffect(() => {
    ...
    >
      <motion.div
        ...
        style={{
          ...
          height: '60vw',
          borderRadius: '50%',
          background: 'radial-gradient(circle, var(--mood-accent) 0%, transparent 70%)',
          filter: 'blur(90px)',
          pointerEvents: 'none',
          zIndex: 0
        }}
...
function App() {
  ...
  return (
    <>
      <AnimatePresence>
        {loading && <AppleHelloLoader onComplete={() => setLoading(false)} />}
      </AnimatePresence>
